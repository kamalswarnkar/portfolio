  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 2.7, ease: [0.22, 0.8, 0.2, 1] }}
      />
      ...
      <motion.div
        ...
        transition={{ duration: 2.45, times: [0, 0.16, 0.34, 0.52, 0.74, 1] }}
      />
      ...
      <motion.div
        ...
        transition={{ duration: 1.95, delay: 0.78, ease: "easeOut" }}
      />
      ...
      <motion.div
        ...
        transition={{ duration: 2.1, times: [0, 0.22, 0.38, 0.5, 0.72, 1] }}
      />
    </motion.div>
  );
}
